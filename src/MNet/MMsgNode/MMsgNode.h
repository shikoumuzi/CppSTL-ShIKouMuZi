...
#define __MUZI_MMSGNODE_MSGNODE_HEADER_SIZE_IN_BYTES__ sizeof(MMsgNodeDataBaseMsg)
...
#define __MUZI_MMSGNODE_PACKAGE_MAX_SIZE_IN_BYTES__ __MUZI_MMSGNODE_MSGNODE_DEFAULT_ARG_SIZE__ + __MUZI_MMSGNODE_MSGNODE_RAW_HEADER_SIZE_IN_BYTES__ + 1
